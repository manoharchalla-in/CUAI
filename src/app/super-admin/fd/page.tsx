...
export default function SuperAdminFormDiagnosticsPage() {
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[#8a8a8e] mt-0.5">
              Live root inspection of student submissions, client environment specs, and field interaction speeds
            </p>
          </div>
